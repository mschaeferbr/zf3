                                ...
                                return (
                                    <div key={campo.name} className={campo.className}>
                                        <AutoComplete
                                            ...
                                            onUpdateInput={(v) => this.handleAutoComplete(campo.name, v, campo.url, 'cidades')}
                                        />
                                    </div>
                                );
                                break;
            ...
            <form ref={(f) => {this.form = f; }} onSubmit={this.onSubmit}>
                <div style={{position: 'relative'}}>
                    <CardActions style={{ zIndex: 2, display: 'inline-block', position: 'absolute', top: 0, right: 0}}>
                        ...
                        <FloatingActionButton onTouchTap={this.props.handleAdicionar}>
                            <ContentAdd/>
                        </FloatingActionButton>
                    </CardActions>
